var _Libbum$oration$Native_Markdown = function() {
    ...
    function formatOptions(options) {
        ...
        function toHighlight(code, lang) {
            try {
                if (!lang && options.defaultHighlighting.ctor && options.defaultHighlighting.ctor === 'Just') {
        ...
        if (options.quotes) {
            options.quotes = [options.quotes.doubleLeft, options.quotes.doubleRight, options.quotes.singleLeft, options.quotes.singleRight];
        }
